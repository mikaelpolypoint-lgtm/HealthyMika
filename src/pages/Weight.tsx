...
export default function Weight() {
    ...
    useEffect(() => {
        const q = query(collection(db, 'weight_logs'), orderBy('date', 'asc'));
    ...
    const latestWeight = logs.length > 0 ? logs[logs.length - 1].weight : 91;
                    ...
                    <Card className="bg-brand-primary text-white border-0">
                        ...
                        <div className="space-y-4 mt-4">
                            <div className="flex justify-between items-center p-3 bg-white/10 rounded-lg backdrop-blur-sm">
                                <span className="text-slate-200 text-sm">Current</span>
